...
scenes =  ["scene0000_00", "scene0261_00", 
          "scene0207_00", "scene0307_00"]

#-------需要更换scene和设置时修改这部分就可以了------
...
config = dict(
    ...
    checkpoint_time_idx=checkpoint_time_idx,
    save_checkpoints=save_checkpoints, # Save Checkpoints
