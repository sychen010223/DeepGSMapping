...
def report_progress(params, data, i, progress_bar, iter_time_idx, sil_thres, every_i=1, qual_every_i=1, 
    ...
    if i % every_i == 0 or i == 1:
        ...
        if wandb_save_qual and (i % qual_every_i == 0 or i == 1):
            ...
            plot_rgbd_silhouette(data['im'], data['depth'], im, rastered_depth, presence_sil_mask, silhouette, diff_depth_rmse, psnr, rmse, fig_title, wandb_run=wandb_run, wandb_step=wandb_step, wandb_title=f"{stage} Qual Viz")
